...
#   select(date,
#          new_cases) %>% 
#   mutate(mean_7 = rollmean(new_cases, k = 30, fill = NA)) 

plot1 <- se %>% 
  ggplot(aes(x = date,
             y = new_cases)) +
  geom_col(fill = "#fc8d62") +
  gghighlight(new_cases %in% c("32485", "21802")) +
  theme_light() +
  labs(x = "Date",
       y = "Total Confirmed New Cases",
       title = "Daily New Cases in Sweden",
...
ggplotly(plot1) %>%
  layout(title = list(text = paste0("Daily New Cases in Sweden",
                                    "<br>",
                                    "<sup>",
...
plot_vacc_1 <- vacc_se_long %>% 
  ...
  labs(y = "Number of Doses Administered",
       title = "Number of First and Second Dose Vaccines Administered, by Month",
       fill = "Dose",
...
ggplotly(plot_vacc_1) %>% 
       layout(title = list(text = paste0("Number of First and Second Dose Vaccines Administered, by Month",
                                    "<br>",
                                    "<sup>",
